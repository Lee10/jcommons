...
public class SymmetricEncoder {
	 ...
	 * @return
	 */
	public static String AESEncoder(String rules, String content) {
	 ...
	 * 解密
	 * @param rules 解密规则
	 * @param content 需解密的文本
	 * @return
	 */
	public static String AESDecoder(String rules, String content){
